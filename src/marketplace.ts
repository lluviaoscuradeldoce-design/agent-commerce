...
export class MarketplaceRegistry {
     ...
     */
    publish(listing: Omit<ServiceListing, "id" | "status" | "createdAt" | "updatedAt">): ServiceListing {
     ...
     */
    update(id: string, patch: Partial<Pick<ServiceListing, "name" | "description" | "price" | "status" | "category">>): ServiceListing | null {
        const listings = this.loadListings();
